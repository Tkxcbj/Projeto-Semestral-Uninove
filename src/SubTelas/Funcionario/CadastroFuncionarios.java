...
/*
    o codigo dessa tela vai ser melhorado BEM mais.
*/
...
public class CadastroFuncionarios extends javax.swing.JFrame {
    ...
    private void BotaoCadrastarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCadrastarActionPerformed
        ...
        if(txfEstado.getText().equalsIgnoreCase("") | estados.indexOf(txfEstado.getText()) == -1){
        ...
        if(cadastroDao.conectar()){
            if(enderecoDao.conectar()){
                ...
                if(resposta != -1){
                    ...
                    if(resposta == 1){
                        JOptionPane.showMessageDialog(null, "usuario cadastrado com sucesso"); //Fim esperado
                        atualizar.doClick();
