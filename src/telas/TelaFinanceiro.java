...
public class TelaFinanceiro extends javax.swing.JFrame {
    ...
    public TelaFinanceiro(String cargo) {
        initComponents();
        TextPrompt tx = new TextPrompt("Digite o nome do Dentista", txtPesquisar);
    ...
    private void mostrarDados() {
        ...
        if (financeiroDao.conectar()) {
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel conectar ao banco de dados", "eroo", JOptionPane.ERROR_MESSAGE);
        }
    }

    private void redimensionaGrafico(String nome, JLabel local) {
        ImageIcon icon = new ImageIcon("src\\view\\" + nome + ".png"); //casa
